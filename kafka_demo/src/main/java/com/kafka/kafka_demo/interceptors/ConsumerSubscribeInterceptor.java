...
import com.kafka.kafka_demo.serializer.MyDeserializer;
 ...
 */
@Slf4j
public class ConsumerSubscribeInterceptor {
    public static void main(String[] args) {
        ...
        //指定消费者分组id
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "cc");
...
//                    log.info("===========topic:" + topic +"\n分区partition:" + partition + "\n偏移量offset:" + offset + "\nkey:" + key + "\nvalue:" + value +"\ntimestamp" + timestamp);
                    ...
                    log.info("===========topic:" + topic +"==分区partition:" + partition + "==偏移量offset:" + offset + "==key:" + key + "==value:" + value +"==timestamp" + timestamp+"==headers:" +new String(headers.lastHeader("user").value()));
                }
            }
            //死循环让一下线程  防止机子卡死
            Thread.yield();
